...
// Modificando o nome do componente para debugar
Container.displayName = 'ContainerCreateAppointent';
...
export const UserAvatar = styled.Image`
  ...
  height: 56px;
  border-radius: 28px;
  /* margin-left com o máximo de espaço disponível */
  margin-left: auto;
`;
...
export const Title = styled.Text`
  ...
  color: #f4ede8;
  font-size: 24px;
  /* 0 em cima, 24px nas laterais e 24px embaixo */
  margin: 0 24px 24px;
`;
...
export const SectionContent = styled.ScrollView.attrs({
  // Adicionando uma propriedade de estilização no componente
  contentContainerStyle: { paddingHorizontal: 24 },
  // Adicionando mais uma propriedade por dentro dos estilos
  horizontal: true,
